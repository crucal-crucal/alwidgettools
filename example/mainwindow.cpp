...
void MainWindow::initEdgeLayout() {
	...
	menuBar->addALIconAction(CALIconFactory::createIconType(ALIcon::AweSomeIcon::AtomSimple), tr("action menu"));
	const auto iconMenu = menuBar->addMenu(CALIconFactory::createIconType(ALIcon::AweSomeIcon::Aperture), tr("icon menu"));
	iconMenu->setMenuItemHeight(27);
	iconMenu->addAction(CALIconFactory::createIconType(ALIcon::AweSomeIcon::BoxCheck), tr("sort"), QKeySequence::SelectAll);
...
void MainWindow::initContent() {
	...
	addPageNode(m_home->windowTitle(), m_home, CALIconFactory::createIconType(ALIcon::FluentIcon::Home));
	// card
	m_card = new E_Card(this);
	addPageNode(m_card->windowTitle(), m_card, CALIconFactory::createIconType(ALIcon::FluentIcon::QuickNote));
	// popup
	m_popup = new E_Popup(this);
	addPageNode(m_popup->windowTitle(), m_popup, CALIconFactory::createIconType(ALIcon::AweSomeIcon::WindowMaximize));
	// navigation
	m_navigation = new E_Navigation(this);
	addPageNode(m_navigation->windowTitle(), m_navigation, CALIconFactory::createIconType(ALIcon::AweSomeIcon::LocationArrow));

	/// expanderNode
	// icon
	QString iconExpanderKey{};
	addExpanderNode("CALIcon", iconExpanderKey, CALIconFactory::createIconType(ALIcon::AweSomeIcon::CabinetFiling));
	m_fluenticon = new E_Icon(QMetaEnum::fromType<ALIcon::FluentIcon>(), this);
	m_fluenticon->setWindowTitle("CALFluentIcon");
	m_fluenticon->init();
	addPageNode(m_fluenticon->windowTitle(), m_fluenticon, iconExpanderKey, 199, CALIconFactory::createIconType(ALIcon::AweSomeIcon::FontCase));
	m_awesomeicon = new E_Icon(QMetaEnum::fromType<ALIcon::AweSomeIcon>(), this);
	m_awesomeicon->setWindowTitle("CALIcon");
	m_awesomeicon->init();
	addPageNode(m_awesomeicon->windowTitle(), m_awesomeicon, iconExpanderKey, 99, CALIconFactory::createIconType(ALIcon::AweSomeIcon::FontCase));
	// baseComponents
	QString baseExpanderKey{};
	addExpanderNode("CALBaseComponents", baseExpanderKey, CALIconFactory::createIconType(ALIcon::AweSomeIcon::CabinetFiling));
	m_toggleSwitchExample = new E_ToggleSwitch_Example(this);
	addPageNode(m_toggleSwitchExample->windowTitle(), m_toggleSwitchExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_spinBoxExample = new E_SpinBox_Example(this);
	addPageNode(m_spinBoxExample->windowTitle(), m_spinBoxExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_sliderExample = new E_Slider_Example(this);
	addPageNode(m_sliderExample->windowTitle(), m_sliderExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_radioButtonExample = new E_RadioButton_Example(this);
	addPageNode(m_radioButtonExample->windowTitle(), m_radioButtonExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_progressBarExample = new E_ProgressBar_Example(this);
	addPageNode(m_progressBarExample->windowTitle(), m_progressBarExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_plainTextEditExample = new E_PlainTextEdit_Example(this);
	addPageNode(m_plainTextEditExample->windowTitle(), m_plainTextEditExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_multiSelectComboboxExample = new E_MultiSelectCombobox_Example(this);
	addPageNode(m_multiSelectComboboxExample->windowTitle(), m_multiSelectComboboxExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_messageBarExample = new E_MessageBar_Example(this);
	addPageNode(m_messageBarExample->windowTitle(), m_messageBarExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_circularProgressExample = new E_CircularProgress_Example(this);
	addPageNode(m_circularProgressExample->windowTitle(), m_circularProgressExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_checkboxExample = new E_CheckBox_Example(this);
	addPageNode(m_checkboxExample->windowTitle(), m_checkboxExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	m_tabWidgetExample = new E_TabWidget_Example(this);
	addPageNode(m_tabWidgetExample->windowTitle(), m_tabWidgetExample, baseExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedListMirrored));
	// view
	QString viewExpanderKey{};
	addExpanderNode("CALView", viewExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::List));
	m_listView = new E_ListView(this);
	addPageNode(m_listView->windowTitle(), m_listView, viewExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::BulletedList));
	m_tableView = new E_TableView(this);
	addPageNode(m_tableView->windowTitle(), m_tableView, viewExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::Tablet));
	m_treeView = new E_TreeView(this);
	addPageNode(m_treeView->windowTitle(), m_treeView, viewExpanderKey, CALIconFactory::createIconType(ALIcon::FluentIcon::TreeFolderFolder));
	/// fotterNode
	// about
	m_about = new E_About;
	QString aboutKey{};
	addFooterNode(m_about->windowTitle(), nullptr, aboutKey, 0, CALIconFactory::createIconType(ALIcon::FluentIcon::OtherUser));
	m_about->hide();
	...
	QString settingKey{};
	addFooterNode(m_settings->windowTitle(), m_settings, settingKey, 0, CALIconFactory::createIconType(ALIcon::FluentIcon::Settings));
	// home conntection

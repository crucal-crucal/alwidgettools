...
class CALWIDGETTOOLS_EXPORT CALInteractiveCard : public QPushButton {
	Q_OBJECT
	Q_DECLARE_PRIVATE(CALInteractiveCard)
	Q_PROPERTY(ALCardPixType::PixMode cardPixMode READ getCardPixMode WRITE setCardPixMode NOTIFY sigCardPixModeChanged)
...
public:
	explicit CALInteractiveCard(QWidget* parent = nullptr);
	~CALInteractiveCard() override;

...
void CUVThemeManager::setThemeMode(const ALThemeType::ThemeMode& mode) {
	d_func()->themeMode = mode;
	Q_EMIT sigThemeModeChanged(mode);
}

ALThemeType::ThemeMode CUVThemeManager::getThemeMode() const {
...
void CUVThemeManager::setThemeColor(const ALThemeType::ThemeMode& mode, const ALThemeType::ThemeColor& color, const QColor& newColor) {
	Q_D(CUVThemeManager);
...
const QColor& CUVThemeManager::getThemeColor(const ALThemeType::ThemeMode& mode, const ALThemeType::ThemeColor& color) const {

...
/**
 * @brief \class CUVMenuPrivate
 * Internal class for CUVMenu
...
QAction* CUVMenu::addAction(const QString& text) {
...
QAction* CUVMenu::addAction(const QIcon& icon, const QString& text) {
...
QAction* CUVMenu::addAction(const QIcon& icon, const QString& text, const QKeySequence& shortcut) {
	const auto action = new QAction(text, this);
	action->setIcon(icon);
	action->setShortcut(shortcut);
	QMenu::addAction(action);
...
QAction* CUVMenu::addAction(const QIcon& icon, const QString& text, const QObject* receiver, const char* member, const QKeySequence& shortcut) {

 ...
 */
CUVColorValueSliderStyle::CUVColorValueSliderStyle(QStyle* style) {
...
void CUVColorValueSliderStyle::setBaseColor(const QColor& color) {
	m_baseColor = color;
}

QColor CUVColorValueSliderStyle::getBaseColor() const {
	return m_baseColor;
}

void CUVColorValueSliderStyle::drawComplexControl(const ComplexControl cc, const QStyleOptionComplex* opt, QPainter* p, const QWidget* widget) const {
	switch (cc) {
...
int CUVColorValueSliderStyle::pixelMetric(const PixelMetric metric, const QStyleOption* option, const QWidget* widget) const {
	switch (metric) {
...
int CUVColorValueSliderStyle::styleHint(const StyleHint stylehint, const QStyleOption* opt, const QWidget* widget, QStyleHintReturn* returnData) const {
...
void CUVColorValueSliderStyle::startRadiusAnimation(const qreal startRadius, const qreal endRadius, QWidget* widget) const {
	const auto style = const_cast<CUVColorValueSliderStyle*>(this);

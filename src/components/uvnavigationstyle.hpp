...
class CUVNavigationStyle final : public QProxyStyle {
	Q_OBJECT
...
public:
	explicit CUVNavigationStyle(QStyle* style = nullptr);
	~CUVNavigationStyle() override;
	...
	void setNavigationView(CUVNavigationView* navigationView);
	[[nodiscard]] CUVNavigationView* getNavigationView() const;
...
private:
	...
	CUVNavigationNode* m_expandAnimationTargetNode{ nullptr };
	...
	static bool compareItemY(CUVNavigationNode* node1, CUVNavigationNode* node2);
};
